...
public final class ServiceManager {
    ...
    public Map<Object, Intent> mBindServiceMap = new HashMap<>();
    ...
    public int onStartCommand(Intent proxyIntent, int flags, int startId) {
        ...
        Intent targetIntent = proxyIntent.getParcelableExtra("original_service");
    ...
    public int stopService(Intent targetIntent) {
        ...
        if (mServiceMap.isEmpty()) {
            ...
            Context appContext = HostApplication.getAppCtx();
    ...
    private ServiceInfo selectPluginService(Intent pluginIntent) {
        for (ComponentName componentName : mServiceInfoMap.keySet()) {
            if (componentName.getClassName().equals(pluginIntent.getComponent().getClassName())) {
    ...
    private void proxyCreateService(ServiceInfo serviceInfo) throws Exception {
        ...
        serviceInfo.applicationInfo.packageName = HostApplication.getAppCtx().getPackageName();
