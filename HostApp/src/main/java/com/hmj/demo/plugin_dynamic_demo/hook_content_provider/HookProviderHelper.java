package com.hmj.demo.plugin_dynamic_demo.hook_content_provider;
...
public class HookProviderHelper {
     ...
     * @param context
     */
    public static void initProviderHook(Context context) throws Exception {
        for (PluginItem item: PluginHelper.plugins) {
            loadProviders(context,new File(item.getPluginPath()));
        }
    }
    /**
     ...
     * @throws Exception
     */
    private static void loadProviders(Context context, File apkFile) throws Exception {
