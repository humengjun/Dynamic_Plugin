...
public class PluginBindService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        Toast.makeText(this,"Plugin1 onBind!",Toast.LENGTH_SHORT).show();
        return binder;
    }
    ...
    public void onCreate() {
        super.onCreate();
        Toast.makeText(this,"Plugin1 onCreate!",Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Toast.makeText(this,"Plugin1 onDestroy!",Toast.LENGTH_SHORT).show();
    }

    @Override
    public boolean onUnbind(Intent intent) {
        Toast.makeText(this,"Plugin1 onUnbind!",Toast.LENGTH_SHORT).show();
